...
function add_meter()
{
    ...
    $('.modal-title').html('<strong>Add Availability Type</strong>'); // Set Title to Bootstrap modal title
}
 
function edit_meter(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('form-group-error'); // clear error class
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('availability_meter/ajax_add'); ?>";
    } else {
            ...
            <div class="modal-body ">
                 <form action="#" id="form" class="form-horizontal">
                    ...
                    <fieldset class="form-group ">
                        ...
                        <input type="text" name="am_desc" class="form-control" placeholder="Description">
                        <small class="text-muted"></small>
                    </fieldset>
                    <fieldset class="form-group ">
                      
                          <select name="set_limit" class="form-control" required>
