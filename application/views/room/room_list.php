   <div style="background-color: transparent;" class="panel">
     	<div class="panel-body">
              <form class="inline" action="<?=site_url('room/showAvailableRooms')?>" method="GET" novalidate> 
                ...
                <div class="form-group col-md-3">
                 <h4> <label  style="color: #867666" class="control-label" for="out">Check Availability</label></h4>
                   <button name="homebutton" value="viewAvailability"  onclick="this.form.submit()" class="btn btn-primary">Show Rooms </button>
                </div>
              </form>
