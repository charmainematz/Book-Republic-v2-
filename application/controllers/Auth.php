...
class Auth extends Admin_Controller {
	...
	//	}
		else
		{
			...
			$this->data['page_desc'] = 'User Control Panel';
		    $this->data['m'] = 'Users ';
		    $this->data['c'] = 'Users';
	...
	public function loginwithfacebook(){
       ...
       // $data['data'] = $this->data;
        ...
        $this->data['page_desc'] = 'User Control Panel';
        	...
        	$this->data['subview'] = 'auth/fb_login';
				$this->load->view('layouts/_layout_main', $this->data);
	...
	public function home()
	{
				...
				$this->data['genre'] = $this->genre_m->get();
				$this->data['users'] = $this->user_m->get();
				$this->data['subview'] = 'auth/home';
				$this->load->view('layouts/frontend_layout', $this->data);
	...
	public function register()
	{
		...
		else
		{
			...
			$this->data['subview'] = 'auth/register';
			$this->load->view('layouts/frontend_layout', $this->data);
		}
	}
	...
	public function logout()
	{
		...
		$this->access_log_m->add_log('Account log out.', $this->session->userdata('user_id'));
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->data['page_desc'] = 'Admin Control Panel';
		    $this->data['m'] = ' ';
		    $this->data['c'] = 'User';
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			$this->data['subview'] = 'auth/reset_password';
			   $this->load->view('layouts/_layout_guest',$this->data);
